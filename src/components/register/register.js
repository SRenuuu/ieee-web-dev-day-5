            ...
            <Row className="m-auto h-100">
                <Col md={{span: 6, offset: 3}} lg={{span: 4, offset: 3}} className="m-auto">
                    <Card text="white" className="form-card m-0 p-0">
                        <Card.Header className="card-title p-4"><h4 className="m-0">Register Form</h4></Card.Header>
                        <Card.Body className="px-5 py-5">
                            ...
                            <Form>
                                ...
                                <Form.Group className="mb-4 mt-4" controlId="formBasicPassword">
                                    ...
                                    <Form.Control className="mt-1 mb-2" type="password" placeholder="Create Password"
                                                  value={password} onChange={(e) => setPassword(e.target.value)}/>
                                </Form.Group>
                                <Form.Group className="mb-4 mt-4" controlId="formBasicPassword">
                                    <Form.Label><MdLock/>&nbsp;&nbsp;Confirm Password</Form.Label>
                                    <Form.Control className="mt-1 mb-2" type="password" placeholder="Re-enter Password"
                                                  value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)}/>
                                </Form.Group>
                                <Link to="/register">
                                    <Form.Text className="info-text-2 pt-3">Already have an account?</Form.Text>
                                </Link>
                                <br/>
                                <br/>
